...
from streamlit_common import setup_for_azure, \
                             setup_for_streamlit, \
                             load_data, \
                             write_session_data_to_local_file
...
try:
    ...
    write_session_data_to_local_file(error_string)
    raise e